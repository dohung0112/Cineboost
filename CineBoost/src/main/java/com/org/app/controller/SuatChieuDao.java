...
public class SuatChieuDao extends Dao<String, SuatChieu> {
    ...
    private String SELECT_ALL_SQL = "SELECT * FROM SUATCHIEU";
    ...
    private String SELECT_WITH_DATE = "SELECT * FROM SUATCHIEU WHERE NGAYCHIEU = ?";
    private String SELECT_TTDATVE = "{CALL SP_LICHCHIEUNGAY(?,?,?,?)}";
    
    private String SELECT_BY_NGAY_PHONG = "SELECT * FROM SUATCHIEU WHERE NGAYCHIEU = ? AND ID_PHONG = ?";

...
public class KichCoDoAnDao extends Dao<Integer, KichCoDoAn>{
    ...
    String SELECT_DOAN_SQL = "SELECT ID_KCDA, DOAN.ID_DOAN, DOAN.TEN, DOAN.ID_LOAI, LDA.TEN, ID_KICHCO, GIA FROM KICHCODOAN KCDA JOIN DOAN DOAN ON KCDA.ID_DOAN = DOAN.ID_DOAN JOIN LOAIDOAN LDA ON DOAN.ID_LOAI = LDA.ID";

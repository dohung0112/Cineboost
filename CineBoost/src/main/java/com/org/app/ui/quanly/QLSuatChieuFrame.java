...
//            dcNgayFilter.setDate(DateHelper.now());
    ...
    public void setUp() {
        setDateChooserUnEditable(dcNgay);
        setDateChooserUnEditable(dcNgayFilter);
...
//                System.out.println("fitler day = "+ dcNgayFilter.getDate().toString());
            ...
            System.out.println("mapphim = "+ phimMap);
...
//        setUpdatingState();
        ...
        System.out.println("selected ngay: "+ selectedItem );
        LocalDateTime dtsuat = DateHelper.toLocalDateTime(selectedItem.getNgayChieu(), selectedItem.getGioBatDau());
        if (isUpdateMode() && DateHelper.compare(dtsuat, LocalDateTime.now()) <= 0)
        {
    ...
    private void loadSuatChieuTbl(String id_phong) {
        try {
            ...
            if(isNgayFilterOn()) {
                ...
                System.out.println("get filter day ");
            }
    ...
    private void loadPhimCombo() {
        ...
        System.out.println("comboPhim "+ cboPhim.getItemCount());
...
//        cboPhongFilter.removeAllItems();
    ...
    private void changeFormButtonState() {
        ...
        updateControlState();
        btnFirst.setEnabled(!noSuat);
        btnPre.setEnabled(!noSuat && phimSuatMap.size() > 1);
        btnNext.setEnabled(!noSuat && phimSuatMap.size() > 1);
        btnLast.setEnabled(!noSuat );
...
//        System.out.println("index = "+ index);
        ...
        System.out.println("setSuatchieu action");
    ...
    private SuatChieu getForm() {
        ...
        System.out.println("sc default = "+ sc.getId());
...
//            System.out.println("scGetForm = "+ sc.toFullString());
            if(checkUpdateSuat(sc)) {
                scdao.update(sc);
                MessageHelper.message(this, "Update thành công",ColorAndIconBank.Icon.UPDATE);
...
//                System.out.println("not true");
        ...
        for(SuatChieu s : suatChieuList) {
            if(TimeHelper.compare(newGbd, s.getGioBatDau()) == 0
                ...
                if(isUpdateMode()) return true;
                    ...
                    mess = String.format("Giờ chieu trùng với suất chiếu %s(%s-%s)",
    ...
    private void insert() {
        try {
            ...
            if(checkUpdateSuat(sc)) {
                scdao.insert(sc);
                MessageHelper.message(this, "Insert thành công",ColorAndIconBank.Icon.UPDATE);
                setFilterIndex();
    ...
    private int findMatchSC(SuatChieu sc) {
        SuatChieu s = (SuatChieu) scItemList.stream().map(e -> e.getSuatChieu()).filter(e -> (
...
//        tblSuatChieu.clearSelection();
        ...
        index = -1;
//        scItemList.get(index).setItemUnSelected();
        if(isNgayFilterOn()) dcNgay.setDate(dcNgayFilter.getDate());
        else dcNgay.setDate(DateHelper.now());
...
//            System.out.println("added item");
    ...
    private void initComponents() {
        ...
        pnlGio.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 80, 30));
        ...
        pnlGio.add(spnHour, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 13, 55, 30));

        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setText(":");
        pnlGio.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(185, 18, 14, -1));

        spnMinute.setModel(new javax.swing.SpinnerNumberModel(0, 0, 59, 5));
        spnMinute.setFocusable(false);
        spnMinute.setMaximumSize(new java.awt.Dimension(41, 20));
        spnMinute.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                spnMinuteStateChanged(evt);
            }
        });
        pnlGio.add(spnMinute, new org.netbeans.lib.awtextra.AbsoluteConstraints(209, 13, 55, 30));
                ...
                .addGroup(pnlContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlContentLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(btnChangeState, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            ...
                            .addComponent(cboPhongFilter, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(pnlContentLayout.createSequentialGroup()
                        .addGap(12, 12, 12)

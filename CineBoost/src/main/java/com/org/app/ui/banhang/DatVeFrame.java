...
//                    showGheMap();
            ...
            service.invokeAll(calls);
            System.out.println("done loadTT");
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    private void loadCboPhim() {
        System.out.println("loadCboPhim");
        try {
    ...
    void loadPhong(List<SuatChieu> scPhim) {
        try {
            System.out.println("loading Phong");
            pcm.clear();
   ...
   private  List<SuatChieu> findbyPhim(String idp) {
    ...
    public void setDatVeFor(SuatChieu sc) {
        ...
        System.out.println("\tphim = "+ p);
        System.out.println("\tsc gio "+ sc.getGioBatDau());
    ...
    public void setDatVeForLongTerm(SuatChieu sc) {
        ...
        CURRENT_TIME = TimeHelper.minus(sc.getGioBatDau(), 60);
    ...
    void selectedPhim() {
        ...
        loadLich(phim.getId());
//        loadPhong(findbyPhim(phim.getId()));
        System.out.println("selected phim in Datveframe");
...
//        List<Ghe> gl = gheP.getSelectedGhe();

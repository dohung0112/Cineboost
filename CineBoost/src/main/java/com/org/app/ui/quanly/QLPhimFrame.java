...
//            if (list.size() != 0 &row == -1) row = 0; edit();
    ...
    public void insert() {
        ...
        try {
            ...
            e.printStackTrace();
             MessageHelper.message(this, "Thêm mới thất bại!", 0);
        }
    }
...
//        p.setNv("NV00001");
    ...
    private boolean checkForm() {
        ...
        if (thoiluong > 240) {
            MessageHelper.message(this, "Thời lượng phim không được quá 4 giờ", 1);
            return false;
        }
...
//        InputFocusGUIUtil.setFocusEffect(focusColor, unfocusColor , txtUserName,jLabel1);
    ...
    private void initComponents() {
        ...
        tblPhim.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Phim", "Tên phim", "Thời lượng", "Thể loại", "Ngày chiếu", "Ngôn ngữ", "Trạng thái", "Tóm tắt"
            }
        ) {
        ...
        rdoDangChieu.setFont(new java.awt.Font("Corbel", 1, 14)); // NOI18N
        ...
        spnGio.setModel(new javax.swing.SpinnerNumberModel(0, 0, 3, 1));
        spnGio.setToolTipText("Giờ");

        btgTrangThai.add(rdoDungChieu);
        rdoDungChieu.setFont(new java.awt.Font("Corbel", 1, 14)); // NOI18N
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(24, 24, 24)
                                .addComponent(rdoDungChieu, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QLPhimFrame().setVisible(true);
            }
        });
    }

...
public class QLDonThanhToanFrame extends javax.swing.JFrame implements SubFrame<QLNhanVienFrame>,SubPanelCreatorInterfaces<SubFrame> {
    ...
    public QLDonThanhToanFrame() {
        ...
        setUp();
//        renderFrame();
////        jLabel1.setIcon(new ImageIcon(getClass().getResource("/icon/pic.jpg")));
//        jLabel1.setIcon(ScaleImageIconGenerator.getScaledIcon("pic.jpg", jLabel1));
////        sp.setVisible(true);
////        pnlContent.add(sp.getContentPanel());
//
...
//        List<Object[]> list = dao.getQLDonThanhToan();
//        for (Object[] row : list) {
//            String suatChieu = TimeHelper.toStringWithHourMintues((Time) row[1]);
//            Date ngayMua_Date = DateHelper.toDate(row[2].toString(), 1);
//            String ngayMua_String =  DateHelper.toString(ngayMua_Date);          
//            String loaiKH = row[3].equals("NULL")?"Tự do": "Thành viên";
//            model.addRow(new Object[]{row[0], suatChieu, ngayMua_String, loaiKH, row[4]});
//        }
    }
...
//    
    ...
    private void initComponents() {
        ...
        tblDonThanhToan.setToolTipText("Chọn và click chuột phải 2 lần để xem chi tiết");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 700, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 653, Short.MAX_VALUE)
        );

...
public class HoaDonChiTietFrame extends javax.swing.JFrame implements SubFrame<HoaDonChiTietFrame>,SubPanelCreatorInterfaces<SubFrame> {
    ...
    private void initComponents() {
        ...
        btnQuayLai.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8_sort_left_26px_5.png"))); // NOI18N
        ...
        lblTongTA.setForeground(new java.awt.Color(0, 0, 0));
        lblTongTA.setText("0");

        lblTongDU.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblTongDU.setForeground(new java.awt.Color(0, 0, 0));
        lblTongDU.setText("0");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông tin đồ ăn", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
        ...
        lblSoGheDC.setForeground(new java.awt.Color(0, 0, 0));
        lblSoGheDC.setText("0");

        lblTienVeNL.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblTienVeNL.setForeground(new java.awt.Color(0, 0, 0));
        lblTienVeNL.setText("0");

        lblTienVeTE.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblTienVeTE.setForeground(new java.awt.Color(0, 0, 0));
        lblTienVeTE.setText("0");

        lblSoGheVip.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblSoGheVip.setForeground(new java.awt.Color(0, 0, 0));

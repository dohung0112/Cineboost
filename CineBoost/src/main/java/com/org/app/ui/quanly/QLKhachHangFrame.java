...
//        renderFrame();
    ...
    private void edit() {
        try {
            ...
            Logger.getLogger(QLKhachHangFrame.class
    ...
    private boolean checkForm() {
        ...
        if (rong) {
           // msg.showMessage("Báo lỗi", "Ô nhập không được để trống", ColorAndIconBank.Icon.VALID_ERROR);
            //if (msg.getMessageType() == MessageDialog.MessageType.OK) msg.dispose();
            MessageHelper.message(this, "Số điện thoại không được để trống", 1);
            return false;
        }
        return true;
    }

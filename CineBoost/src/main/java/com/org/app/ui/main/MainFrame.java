...
import com.org.app.util.FontUtil;
...
//           createSubFrame();
    ...
    private void lockOnRole() {
        ...
        //Tracuulichchieu need to maintaince
//        btnTraLichChieu.setEnabled(false);
    }
    ...
    private void createSubFrame() {
        ...
        createSubFrameAndButtonBinding(QLProfileFrame.CARD_NAME_MAIN, new QLProfileFrame(), lblProfile);
        ...
        //call from other form card
//        pnlRight.add("datVe", new DatMenuFrame(this).getContentPanelFor(pnlRight));
//        pnlRight.add("datDoAn", new DatMenuFrame(this).getContentPanelFor(pnlRight));
...
//    private void setTitleSideMenuFont() {
//        java.awt.Font f = FontUtil.getFont("SVN-REX.ttf");
//
//        lblQuanLy.setFont(f.deriveFont(Font.BOLD, 16F));
//        lblBanHang.setFont(f.deriveFont(Font.BOLD, 16F));
//    }
    ...
    private void addPanels() {
        ...
        System.out.println("pnlRight = " + pnlRight.getComponents());
//       pnlRight.add("profile",new QLProfileFrame().getContentPanelFor(pnlRight));
    }

    private void setProfile() {
        wrap(lblTenTK, Authenticator.USER.getTentk());
        String pic = Authenticator.USER.getAnh();
//        SettingIconHelper.setIconFor(lblProfile, "/images/" + pic);
...
//         pnlRight.removeAll();
         ...
         System.out.println("show card with JLabel");
    ...
    private void launchClock() throws IOException {
        new java.util.Timer().scheduleAtFixedRate(new CalendarAndClock() {
            ...
            public void run() {
                ...
                String ampm = CalendarAndClock.Clock.getAMPM();

...
//            System.out.println(ImageUtil.class.getResource("/images/avatars/" + tv.getAnh()));
    ...
    void chonAnh() {
        if (fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            JOptionPane.showMessageDialog(this, lblAnh.getToolTipText());
        }
    }
    ...
    private boolean checkForm() {
        boolean rong = InputValidlHelper.isEmpty(txtHoTen, txtEmail, txtSoDT, txtTenTK, txtMatKhau, txtXacNhanMK);
        if (rong) {
    ...
    private void initComponents() {
        ...
        txtMatKhau = new com.org.app.weblaf.PasswordTextField();
        txtXacNhanMK = new com.org.app.weblaf.PasswordTextField();
    ...
    private com.org.app.weblaf.PasswordTextField txtMatKhau;
    private javax.swing.JFormattedTextField txtSoDT;
    private javax.swing.JTextField txtTenTK;
    private com.org.app.weblaf.PasswordTextField txtXacNhanMK;

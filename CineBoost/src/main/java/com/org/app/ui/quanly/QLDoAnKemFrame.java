...
//                daoDA.update_SP(model.getDoAn().getTen(), model.getDoAn().getLoaiDoAn().getId(), model.getKichco().getId(), model.getGia(), model.getDoAn().getId(), model.getId());
                this.fillTable((String) cboLocDoAn.getSelectedItem());
                setForm(model);
...
//        System.out.println("kcda: " + kcda.getDoAn().getTen() + " " + kcda.getDoAn().getLoaiDoAn().getId() + " " + kcda.getKichco().getId() + " " + kcda.getGia());
    ...
    private boolean checkForm() {
        boolean rong = InputValidlHelper.isEmpty(txtTenMon, txtGia);
        if (rong) {
    ...
    private void setUpInputFocusListener() {
        ...
        InputFocusGUIUtil.setFocusEffect(focusColor, unfocusColor, new JTextField[]{txtTenMon, txtGia}, jLabel4, jLabel5);
    }
    ...
    private void initComponents() {
        ...
        txtGia.setBackground(new java.awt.Color(128, 128, 128));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblAnhDoAn, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(50, 25));
        jPanel2.setLayout(new java.awt.CardLayout());

        jComboBox1.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        jComboBox1.setLightWeightPopupEnabled(false);
        jComboBox1.setMaximumSize(new java.awt.Dimension(65, 25));
        jComboBox1.setMinimumSize(new java.awt.Dimension(65, 25));
        ...
        jPanel2.add(pnlUpdateF, "card2");

        txtTenMon.setBackground(new java.awt.Color(128, 128, 128));
        ...
        txtTenMon.setRequestFocusEnabled(false);
        ...
        pnlAddFLayout.setHorizontalGroup(
            ...
            .addGroup(pnlAddFLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(txtTenMon, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE))
        );
                    ...
                    .addGroup(pnlThongTinLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlThongTinLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlThongTinLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(cboSize, 0, 194, Short.MAX_VALUE)
                                .addComponent(txtGia))
                            .addComponent(lblID_DoAn, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(pnlThongTinLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlThongTinLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cboLoaiDoAn, javax.swing.GroupLayout.PREFERRED_SIZE, 195, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(28, 28, 28)
                .addGroup(pnlThongTinLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                new QLDoAnKemFrame().setVisible(true);
                QLDoAnKemFrame da = new QLDoAnKemFrame();
                da.setVisible(true);
            }
        });
    }

...
//        now = LocalDateTime.now();
        //test only 
        now = LocalDateTime.of(2022, java.time.Month.APRIL, 18,07, 00, 50);
...
//                        loading();
    ...
    private void setNowTest() {
        now = LocalDateTime.of(2022, java.time.Month.APRIL, 16,23, 01, 30);
    }
...
//        pnl.repaint();
    ...
    private void initComponents() {
        ...
        jPanel1 = new com.org.app.weblaf.GradientPanel("#D3E2E2", "#F3F6D4", 145);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblPhim, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );

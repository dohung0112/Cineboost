...
//        this.setMinimumSize(d);
    ...
    public LichPhimPanelComponent(SuatChieu sc) {
        this();
        this.sc = sc;
        setLabel();
    }
    ...
    public void setLabel() {
        ...
        wrap(lblGio, String.format("%s (%s)",TimeHelper.toStringWithHourMintues(sc.getGioBatDau()), isSuatDaChieu()? "DC" : "SC"));
    ...
    private boolean isSuatDaChieu() {
        ...
        return suat.compareTo(LocalDateTime.now()) <= 0;
    }
    ...
    public void setSelected() {
        gradientPanel1.setColor1(Color.decode("#E8E6CE"));

...
//        System.out.println("array gia = "+ Arrays.toString(totalVeArray));
//        lblVeTreEm.setText(String.format("%d x %.3f", te,totalVeArray[0]));
//        lblVeNguoiLon.setText(String.format("%d x %.3f", nl,totalVeArray[1]));
//        lblPhuThu.setText(currency(veList.getTongPhuThu()));
//        lblTamTinhVe.setText(String.format("%,.3f", totalVeArray[2]));
...
//            menuDoAn.datList.clear();
    ...
    private void updatePnlTongTien() {
        getMaTV();
        double ve = 0;
        double da = 0;
        Double s =  0.0;
        if (!isDoAnOnly) {
            ve = Double.parseDouble(lblTamTinhVe.getText());
            da = Double.parseDouble(lblTamTinhDA.getText().isEmpty()? "0" : lblTamTinhDA.getText());
        }else if (isDoAnOnly) {
...
//-------------------------------------------------------------------------------------
    ...
    private void updateThanhTien() {
        ...
        System.out.println("tamtinh = "+ round);
...
//-------------------------------------------------------------------------------- 
    ...
    private void thanhToan() {
        if(!isBoth && !isDoAnOnly) {
            try {
                System.out.println("List ve : "+ veList);
//                DonThanhToan don = donttDao.addDonThanhToan(VE_ONLY, getMaTV(), Authenticator.USER.getId());
                ...
                if(isGiamGia()) {
                    donttDao.updateTongTien(don.getId(), Double.parseDouble(lblThanhTien.getText()));
                }
                else {
...
//                addVeToDonVe(don.getDonVe());
    ...
    private int getMaGiam() {
        if (!isDoAnOnly) {
            ...
            int slDA = 0;
            return GiamGiaDieuKien.getTestGG();
//        return GiamGiaDieuKien.getGiamGia(slVe, slDA);
        }else {
            int slVe = 0;
            int slDA = doAnList.getSoLuong();
            return GiamGiaDieuKien.getGiamGia(slVe, slDA);
        }
    ...
    private void showDialog(){
        ...
        System.out.println("tv id" + tv.getID());
        setTVTextId();
    }
    ...
    private void initComponents() {
        ...
        gradientPanel1 = new com.org.app.weblaf.GradientPanel();
        pnlThanhTien = new javax.swing.JPanel();
        pnlButton = new javax.swing.JPanel();
        btnThanhVien = new com.org.app.weblaf.ButtonGradient();
        btnThanhToan = new com.org.app.weblaf.ButtonGradient();
        ...
        btnQuayLai = new com.org.app.weblaf.ButtonGradient();
        ...
        btnThanhVien.setColor1(new java.awt.Color(204, 204, 204));
        btnThanhVien.setColor2(new java.awt.Color(204, 204, 204));
        ...
        btnThanhToan.setColorHover1(new java.awt.Color(161, 224, 140));
        btnThanhToan.setColorHover2(new java.awt.Color(156, 214, 136));
                ...
                .addGroup(pnlDonVeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlDonVeLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlDonVeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(lblTamTinhVe, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        pnlMaKHLayout.setHorizontalGroup(
            ...
            .addGroup(pnlMaKHLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtIDThanhVien, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        pnlDetailLayout.setHorizontalGroup(
            ...
            .addGroup(pnlDetailLayout.createSequentialGroup()
                .addGroup(pnlDetailLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(pnlDonVe, javax.swing.GroupLayout.DEFAULT_SIZE, 306, Short.MAX_VALUE)
                    .addComponent(pnlDoAn, javax.swing.GroupLayout.DEFAULT_SIZE, 306, Short.MAX_VALUE)
                    .addComponent(pnlTongTien, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 306, Short.MAX_VALUE))
                .addGap(1, 1, 1))
        );
    ...
    private void btnDetailVeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetailVeActionPerformed
        ...
        detailDialog.setLocation(btnDetailVe.getLocation().x - 10, btnDetailVe.getLocation().y + 130);
    ...
    private com.org.app.weblaf.ButtonGradient btnQuayLai;
    private com.org.app.weblaf.ButtonGradient btnThanhToan;
    private com.org.app.weblaf.ButtonGradient btnThanhVien;
    private com.org.app.weblaf.GradientPanel gradientPanel1;

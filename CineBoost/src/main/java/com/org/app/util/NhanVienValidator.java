...
public class NhanVienValidator extends Validator<NhanVien> {
    ...
    public enum NhanVienValidatorError {
        ...
        DINH_DANG("Mật khẩu ít nhất 1 chữ viết hoa, 1 chu thường va so"),
    ...
    public static void main(String[] args) {
        String ss = "Phòng 2";
//        System.out.println(ss.matches("^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])([a-zA-Z0-9]+)$"));
        System.out.println(ss.replaceAll("(.*\\s{1})(\\d)$","$2"));
